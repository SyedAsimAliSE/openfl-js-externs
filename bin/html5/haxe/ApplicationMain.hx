...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("js-externs-open-fl", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("js-externs-open-fl", null, 800, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "12";
		app.meta["company"] = "Asim";
		app.meta["file"] = "js-externs-open-fl";
		app.meta["name"] = "js-externs-open-fl";
		app.meta["packageName"] = "js-externs-open-fl";
